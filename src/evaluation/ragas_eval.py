...
class RagasEvaluator:
    ...
    async def run(
        ...
        scores_map = cast(dict[str, Any], scores)

        report = EvalReport(
            faithfulness=float(scores_map["faithfulness"]),
            answer_relevancy=float(scores_map["answer_relevancy"]),
            context_recall=float(scores_map["context_recall"]),
            context_precision=float(scores_map["context_precision"]),
